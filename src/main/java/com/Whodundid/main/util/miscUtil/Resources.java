...
public class Resources {
	...
	//guis
	public final static ArrayList<Class> guis;
	...
	static {
		...
		for (SubMod m : RegisteredSubMods.getRegisteredModsList()) {
			if (m.getMainGui(false, null, null) != null) { guis.add(m.getMainGui(false, null, null).getClass()); }
		}
		guis.add(SLSGlobalOptionsGui.class);
		guis.add(SLSPartGui.class);
	}
}
