...
public class EArrayList<E> extends ArrayList<E> {
	...
	protected E elementData(int index) { return (E) elementData[index]; }
    ...
    private class SubList extends AbstractList<E> implements RandomAccess {
        ...
        public E set(int index, E e) {
            rangeCheck(index);
            checkForComodification();
            E oldValue = EArrayList.this.elementData(offset + index);
        ...
        public E get(int index) {
            rangeCheck(index);
            checkForComodification();
            return EArrayList.this.elementData(offset + index);
        }
