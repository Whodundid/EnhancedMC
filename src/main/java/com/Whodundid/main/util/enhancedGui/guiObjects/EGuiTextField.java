...
public class EGuiTextField extends EnhancedGuiObject {
	...
	public void drawObject(int mX, int mY, float ticks) {
		...
		boolean flag1 = (alwaysDrawCursor || hasFocus()) && cursorCounter / 10 % 2 == 0 && flag;
		int l = enableBackgroundDrawing ? startX + 4 : startX;
		int i1 = enableBackgroundDrawing ? startY + (height - 6) / 2 : startY;
		int j1 = l;
	...
	public void onFocusGained(FocusEvent eventIn) {
		if (!alwaysDrawCursor) { cursorCounter = 0; }
