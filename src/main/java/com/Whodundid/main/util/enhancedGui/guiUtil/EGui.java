...
public class EGui {
    ...
    public static int drawString(String text, int x, int y, int color) { return MainMod.getFontRenderer().drawStringI(text, x, y, color); }
    public static int drawCenteredString(String text, int x, int y, int color) { return MainMod.getFontRenderer().drawStringI(text, x - MainMod.getFontRenderer().getStringWidth(text) / 2, y, color); }
    public static int drawStringWithShadow(String text, int x, int y, int color) { return MainMod.getFontRenderer().drawStringWithShadowI(text, x, y, color); }
    public static int drawCenteredStringWithShadow(String text, int x, int y, int color) { return MainMod.getFontRenderer().drawStringWithShadowI(text, x - MainMod.getFontRenderer().getStringWidth(text) / 2, y, color); }
    public static int drawString(String text, int x, int y, int color, float height) { return MainMod.getFontRenderer().drawStringIH(text, x, y, color, height); }
    public static int drawCenteredString(String text, int x, int y, int color, float height) { return MainMod.getFontRenderer().drawStringIH(text, x - MainMod.getFontRenderer().getStringWidth(text) / 2, y, color, height); }
    public static int drawStringWithShadow(String text, int x, int y, int color, float height) { return MainMod.getFontRenderer().drawStringWithShadowIH(text, x, y, color, height); }
    public static int drawCenteredStringWithShadow(String text, int x, int y, int color, float height) { return MainMod.getFontRenderer().drawStringWithShadowIH(text, x - MainMod.getFontRenderer().getStringWidth(text) / 2, y, color, height); }
