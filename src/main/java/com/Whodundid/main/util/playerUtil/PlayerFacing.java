...
public abstract class PlayerFacing {
	...
	public enum Direction {
		...
		public float getDegree() {
			return this.degreeDir;
		}
		
		public String getXZFacing() {
			return xzFacing;
		}
	}
	...
	public static void checkEyePosition(RenderWorldLastEvent e) {
		playerEyeVec3 = new Vector3D(mc.thePlayer.getPositionEyes(e.partialTicks));
	}
